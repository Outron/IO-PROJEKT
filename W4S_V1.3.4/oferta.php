                ...
                if ($wiersz = mysqli_fetch_assoc($ret)) {
                    ...
                    if (@$_SESSION['user']) {
                        if ($_SESSION['typ_uzytkownika'] == "student") {
                            echo "<br>Spodobała ci się ta oferta?<br><br><a href='aplikuj.php?id=" . $wiersz["id"] . "'>Aplikuj</a>";
                        }
                    } else {
                        echo "Spodobała ci się ta oferta?<br><a href='rejestracja.php' class='offer_btn'>Zarejestruj się, aby aplikować</a>";
                    }
                } else {
